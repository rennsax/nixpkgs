...

{
  ...
  components = {
    ...
    ]; # missing inputs: dio-chacon-wifi-api
    "channels" = ps: with ps; [
      pychannels
    ];
    ...
    ]; # missing inputs: israel-rail-api
    "iss" = ps: with ps; [
    ...
    "linkplay" = ps: with ps; [
    ]; # missing inputs: python-linkplay
    ...
    ]; # missing inputs: pyseventeentrack
    "sfr_box" = ps: with ps; [
      sfrbox-api
    ];
    "sharkiq" = ps: with ps; [
